...
export default function Footer() {
  const navigation = {
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/USACEHQ',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/usacehq/',
        icon: (props) => (
          <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
            <path
              fillRule='evenodd'
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/USACEHQ',
        icon: (props) => (
          <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/usace/water',
        icon: (props) => (
          <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
            <path
              fillRule='evenodd'
  ...
  return (
    <footer className='bg-gray-900' aria-labelledby='footer-heading'>
      ...
      <div className='mx-auto px-6 py-8 lg:max-w-screen-2xl lg:px-4'>
          ...
          <div className='col-span-2 text-gray-400'>
            ...
            <div className='mt-8'>
              ...
              <p className='mt-4 text-sm'>
                ...
                based repository of water resources data that includes
                elevation, precipation, storage, and flow status of USACE
                reservoir and lock & dam projects.
              </p>
              <p className='mt-4 text-sm'>
                All data contained herein is preliminary in nature and therefore
                subject to change. The data is for general information purposes
                ONLY and SHOULD NOT be used in technical applications such as,
                but not limited to: studies, designs or critical decision
                support.
              </p>
            </div>
          </div>
