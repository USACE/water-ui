    ...
    const Anonymous = (props) => {
      return (
        <div className='relative inline-flex'>
          <button
            ref={trigger}
            className='inline-flex justify-center items-center h-12 group'
            aria-haspopup='true'
            onClick={() => doAuthLogin()}
          >
            <span className=''></span>
            <div className='flex items-center truncate'>
              <span className='truncate ml-2 text-md font-medium group-hover:text-blue-500'>
                Login
              </span>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-6 w-6 ml-2 group-hover:text-blue-500'
                fill='none'
                viewBox='0 0 24 24'
                stroke='currentColor'
              >
