...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="-mt-10 bg-blue-900 py-2 text-center text-3xl font-bold text-gray-300 opacity-90">
        {/* <span className="text-gray-500">
          U.S. Army Corps of Engineers - Water Resources Data
        </span> */}
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 sm:text-center lg:max-w-7xl lg:px-8">
